...
class Payment(models.Model):
    ...
    status = models.CharField(max_length=10, choices=StatusChoices.choices, default=None)
    type = models.CharField(max_length=10, choices=TypeChoices.choices, default=None)
    borrowing = models.ForeignKey(Borrowing, on_delete=models.CASCADE, related_name="payments", default=None)
